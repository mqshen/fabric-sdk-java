...
/**
 * Created by goldratio on 13/02/2017.
 */
public class End2endITest {

    static final String CHAIN_CODE_NAME = "example";
    static final String CHAIN_CODE_PATH = "github.com/example_cc";

    static final String CHAIN_NAME = "testchainid";

    final static Collection<String> PEER_LOCATIONS = Arrays.asList("grpc://192.168.30.98:7051");


    final static Collection<String> ORDERER_LOCATIONS = Arrays.asList("grpc://192.168.30.98:7050"); //Vagrant maps to this

    final static Collection<String> EVENTHUB_LOCATIONS = Arrays.asList("grpc://192.168.30.98:7053"); //Vagrant maps to this

    final static String FABRIC_CA_SERVICES_LOCATION = "http://192.168.30.98:8888";
